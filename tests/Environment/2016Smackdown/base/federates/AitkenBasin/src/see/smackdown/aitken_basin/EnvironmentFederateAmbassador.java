...
class EnvironmentFederateAmbassador extends NullFederateAmbassador {
	...
	public EnvironmentFederateAmbassador(String fed_name) {
	...
	public ReferenceFrameObject add_published_frame(ReferenceFrame ref_frame, RTIambassador rti_ambassador) {
		...
		if (ref_frame != null) {
			...
			ref_frame_obj = new ReferenceFrameObject(ref_frame, ref_frame.ref_frame_name, encoder_factory);
	...
	public void connectionLost(String faultDescription) throws FederateInternalError {
		...
		System.out.print("\" lost connection to RTI with fault: \"");
		System.out.print(faultDescription);
		System.out.println("\"!");
	...
	@Override
	public void discoverObjectInstance(ObjectInstanceHandle instance_handle, ObjectClassHandle object_class,
			String instance_name, FederateHandle producing_federate) {
		// Delegate.
		this.discoverObjectInstance(instance_handle, object_class, instance_name);
	}
	...
	public void discoverObjectInstance(ObjectInstanceHandle instance_handle, ObjectClassHandle object_class,
		...
		if (ReferenceFrameObject.matches(object_class)) {
			...
			if (expected_frames.containsKey(instance_name)) {
				...
				ref_frame_obj = new ReferenceFrameObject(expected_frame, instance_name, instance_handle,
						encoder_factory);
			} else {
	...
	@Override
	public void objectInstanceNameReservationSucceeded(java.lang.String instance_name) throws FederateInternalError {
	...
	@Override
	public void objectInstanceNameReservationFailed(java.lang.String instance_name) throws FederateInternalError {
		ReferenceFrameObject published_frame;
	...
	@Override
	public void removeObjectInstance(ObjectInstanceHandle instance_handle, byte[] user_tag, OrderType sent_ordering,
	...
	@Override
	public void reflectAttributeValues(ObjectInstanceHandle instance_handle, AttributeHandleValueMap attributes,
			byte[] user_tag, OrderType sent_ordering, TransportationTypeHandle transport_handle,
		...
		if (discovered_frames.containsKey(instance_handle)) {
			...
			// If this is the EarthCentricInertial object then we're
			// initialized.
			if ((ref_frame_name.compareTo("EarthCentricInertial") == 0) && wait_on_init_data) {
	...
	@Override
	public void reflectAttributeValues(ObjectInstanceHandle instance_handle, AttributeHandleValueMap attributes,
			byte[] user_tag, OrderType sent_ordering, TransportationTypeHandle transport_handle, LogicalTime time,
			OrderType received_ordering, SupplementalReflectInfo reflect_info) throws FederateInternalError {
		ReferenceFrameObject ref_frame_obj;
		String ref_frame_name;
	...
	public void reflectAttributeValues(ObjectInstanceHandle instance_handle, AttributeHandleValueMap attributes,
			byte[] user_tag, OrderType sent_ordering, TransportationTypeHandle transport_handle, LogicalTime time,
			OrderType received_ordering, MessageRetractionHandle retraction_handle,
			SupplementalReflectInfo reflect_info) throws FederateInternalError {
		ReferenceFrameObject ref_frame_obj;
		String ref_frame_name;
