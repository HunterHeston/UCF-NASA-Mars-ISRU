...
import federate.PositionVector;
import federate.PositionVectorCoder;
...
public class Rover {
	...
	@Attribute(name="position", coder= PositionVectorCoder.class)
	...
	@ObjectClass(name = "PhysicalEntity.Rover.PhysicalEntity.SubRover")
	public class SubRover {
		/** The identifier. */
		@Attribute(name = "id", coder = HLAinteger32BECoder.class)
		private Integer identifier;
		 ...
		 *            the entity
		 */
		public SubRover(String name, String entity) {
			this.identifier = roverIDCounter;
			roverIDCounter++;
