...
public class Planet {
	...
	public Planet(String planet_name, DE405_Body planet_id) {
		...
		fixed = new ReferenceFrame(planet_name + "CentricInertial", planet_name + "CentricFixed");
	}

	public Planet(ReferenceFrame parent_ref_frame, String planet_name, DE405_Body planet_id) {
		parent = parent_ref_frame;
		name = new String(planet_name);
		id = planet_id;
		inertial = new ReferenceFrame(parent_ref_frame.ref_frame_name, planet_name + "CentricInertial");
		fixed = new ReferenceFrame(planet_name + "CentricInertial", planet_name + "CentricFixed");
	}
